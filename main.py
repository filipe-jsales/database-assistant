...
def get_api_response(prompt, context=""):
    ...
    maximum_tokens = int(os.getenv("NUM_TOKENS", 100))
    ...
    system_instructions = (
        ...
        f"Respeite o limite de tokens definido por {maximum_tokens}. e responda em PT-BR."
    )

    headers = {"Content-Type": "application/json"}
    full_prompt = f"{system_instructions}\n\n{context}\n\n{prompt}" if context else f"{system_instructions}\n\n{prompt}"
    data = {
